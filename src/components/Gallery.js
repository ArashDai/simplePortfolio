  ...
  render:function(){
    return(
      ...
      <div className='container-fluid Card text-center row' id='contactpage'>
            ...
            <img id='galleryimage' src='../assets/8541324913_b9a3c0636f_o.jpg' className='img-responsive col-xs-12 col-sm-4 col-md-3 col-lg-2'/>

            <img id='galleryimage' src='../assets/5571576218_3ac3a56b82_o.png' className='img-responsive col-xs-12 col-sm-4 col-md-3 col-lg-2'/>
           
            <img id='galleryimage' src='../assets/14366938271_225109c3f4_o.jpg' className='img-responsive col-xs-12 col-sm-4 col-md-3 col-lg-2'/>

            <img id='galleryimage' src='../assets/5237184565_2c769184ac_o.jpg' className='img-responsive col-xs-12 col-sm-4 col-md-3 col-lg-2'/>
